...
To get a sense of what data goes into the score, see the online [calculator provided by the American College of Cardiology](https://tools.acc.org/ASCVD-Risk-Estimator-Plus/#!/calculate/estimate/):  
![](C:/Users/Fab/Dropbox/PC/Documents/Estudo/Tecnologia/phea/phea/docs/img/ascvd_calculator.png){ width=100% }

The mathematical formula for the score is a bit convoluted. I discuss that further down in this vignette.  
