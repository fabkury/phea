...
The truth is, the formula as written over there _is slightly wrong_. By going through the numbers and examples in the paper, and calculating by hand, one can realize that the ASCVD+ formula actually is:  
...
ascvd |> select( # Let's NOT plot the columns below
    -ends_with('datetime'),
