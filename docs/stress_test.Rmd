...
In this vignette we perform two stress tests:  
 ...
 a. Compute formulas with 1 to 210 components, each coming from a different record source (SQL query).  
 b. Compute a formula, use it as a component in another formula, repeat that consecutively 1 to 210 times.  
 c. Compute formulas with 1 to 210 components, all from the same record source (SQL query).
