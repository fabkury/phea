...
> **P = coalesce(C<sub>1</sub><sup>value_as_number</sup>) + coalesce(C<sub>2</sub><sup>value_as_number</sup>) + coalesce(C<sub>2</sub><sup>value_as_number</sup>) + ... + coalesce(C<sub>n</sub><sup>value_as_number</sup>)**  
